...
function App() {
  ...
  return (
    <>
      ...
      <section className="flex flex-col gap-8 md:grid  md:grid-cols-3  justify-between items-center px-6 pt-4">
        <div>

          <div className="h-[100px] w-[360px] ml-[60px] -mb-[45px] bg-cover " style={{
            backgroundImage: "url('Text_Bubble.png')",
          }} >
            <p className="text-[22px] px-8 pt-[12px] text-glacial leading-6 font-[400]">Click on a style you'd like to learn more about.</p>
          </div>
        ...
        <div className="flex gap-4 items-center justify-end ">
          <div className="w-[105px] h-[110px] flex items-center justify-center " style={{
